...
class AddSubnet4
{
    ...
    public function validate_post($values)
    {
        /*  define rules */
        $rules['subnet'] = [
           'method' => 'exist|subnet4format|subnetoverldap4:exist_false',
           'msg'    => [
                         _(AddSubnet4::MSG_SUBNET_EMPTY),
                         _(AddSubnet4::MSG_SUBNET_INVALID),
                         _(AddSubnet4::MSG_SUBNET_OVERLDAP)
                       ],
           'log'    => [
                         AddSubnet4::LOG_SUBNET_EMPTY,
                         sprintf(AddSubnet4::LOG_SUBNET_INVALID, $values['subnet']),
                         sprintf(AddSubnet4::LOG_SUBNET_OVERLDAP, $values['subnet']),
                       ],
        ];
    ...
    public function display()
    {
        ...
        $this->store->view->render("addsubnet4.tmpl", $errors);
    }
 ...
 *  main
 ******************************************************************************/
$objASubnet = new AddSubnet4($store);
